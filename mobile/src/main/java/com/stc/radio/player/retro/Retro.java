...
import static com.stc.radio.player.retro.SettingsProvider.AUTH_EXPIRE_DATE;
import static com.stc.radio.player.retro.SettingsProvider.AUTH_TOKEN;
import static com.stc.radio.player.retro.SettingsProvider.prefs;
...
public class Retro {
	...
	public static boolean hasValidToken(){
		if(prefs.contains(AUTH_TOKEN) && prefs.contains(AUTH_EXPIRE_DATE) ){
